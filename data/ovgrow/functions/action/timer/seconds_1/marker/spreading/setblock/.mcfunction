...
execute if score #temp1 ovgrow.temp matches 0 if block ^ ^1 ^1 air if block ^ ^ ^1 #dirt run scoreboard players set #temp1 ovgrow.temp 1
execute if score #temp1 ovgrow.temp matches 0 if block ^ ^ ^1 air if block ^ ^-1 ^1 #dirt run scoreboard players set #temp1 ovgrow.temp 2
execute if score #temp1 ovgrow.temp matches 0 if block ^ ^-1 ^1 air if block ^ ^-2 ^1 #dirt run scoreboard players set #temp1 ovgrow.temp 3
