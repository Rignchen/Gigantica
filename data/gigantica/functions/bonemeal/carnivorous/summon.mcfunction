...
summon iron_golem ~ ~ ~ {Tags: ["gigantica"],ActiveEffects:[{Id:14b,ShowParticles:0b,Duration:-1}],UUID:[I;-253127897,528042453,-1535955459,-435590372],Attributes:[{Base:300,Name:"generic.max_health"}],NoAI:1b}
