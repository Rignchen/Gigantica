...
execute unless entity f0e99327-1f79-49d5-a473-2dfde6096b1c as 1e744292-1204-4aa5-ba41-6a0bfc05c0aa at @s run function gigantica:action/timer/boss/death

#Loop
execute if score #boss_summoned gigantica.temp matches 1 run schedule function gigantica:action/timer/boss/ 2t
