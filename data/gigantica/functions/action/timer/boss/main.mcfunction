...
execute store result score #temp gigantica.temp if predicate gigantica:in_water
execute if score #temp gigantica.temp matches 1 if predicate gigantica:no_regen run effect give @s regeneration 10 1 true
execute if score #temp gigantica.temp matches 1 unless predicate gigantica:no_regen run effect clear @s regeneration
