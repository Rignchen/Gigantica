...
summon minecraft:item_display ~ ~ ~ {Tags:["gigantica","gigantica.spike_target"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:3}},transformation:{translation:[0f,-0.1f,0f],scale:[1f,0f,1f]},UUID:[I;644408288,90785067,-1515551265,-1515243341]}
...
# spike 4edbe160-00d6-4939-a9ac-c3a51159caf4
# display 2668e3e0-0569-452b-a5aa-85dfa5af38b3
#define entity 4edbe160-00d6-4939-a9ac-c3a51159caf4
#define entity 2668e3e0-0569-452b-a5aa-85dfa5af38b3
