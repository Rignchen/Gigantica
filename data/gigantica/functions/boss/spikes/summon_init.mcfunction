...
data merge entity @s {Tags:["gigantica.spikes"],item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:2}},transformation:{translation:[0f,-0.1f,0f],scale:[1f,0f,1f]}}
schedule function gigantica:boss/spikes/animate_in 1s
schedule function gigantica:boss/spikes/target_player 1.2s
schedule function gigantica:boss/spikes/animate_out 4s
